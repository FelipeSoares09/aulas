...
export function SignUp() {
    ...
    const {
        register, handleSubmit, formState: { isSubmitting },} = useForm<SignUpForm>()
                ...
                <div className="flex w-[350px] flex-col justify-center gap-6">
                    ...
                    <form onSubmit={handleSubmit(handleSignUp)} className="space-y-4">
                        ...
                        <p className='px-6 text-center text-sm leading-relaxed text-muted-foreground'>
                            Ao continuar, você concorda com os nosso <a className='underline underline-offset-4' href="#">Termos de serviço</a> e <a className='underline underline-offset-4' href="#">políticas de privacidade</a>.
                        </p>
                    </form>
                </div>
            </div>
