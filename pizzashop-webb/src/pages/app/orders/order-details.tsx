                    ...
                    <Table>
                        <TableBody>
                            ...
                            <TableRow>
                                ...
                                <TableCell className="flex justify-end">{formatDistanceToNow(new Date(order.createdAt), {
                                    addSuffix: true,
                                    locale: ptBR,
                                })}</TableCell>
                            </TableRow>
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {order.orderItems.map(item => {
                                const subtotal = (item.priceInCents / 100) * item.quantity; // Calcula o subtotal
                                return (
                                    <TableRow key={item.id}>
                                        ...
                                        <TableCell className="text-right">{subtotal.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</TableCell>
                                    </TableRow>
                                );
                            })}
                        </TableBody>
